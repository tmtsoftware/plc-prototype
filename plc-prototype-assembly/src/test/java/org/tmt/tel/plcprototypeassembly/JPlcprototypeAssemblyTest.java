...
public class JPlcprototypeAssemblyTest extends JUnitSuite {
    ...
    public static void setup() {
        ...
        testKit.spawnStandalone(com.typesafe.config.ConfigFactory.load("JPlcprototypeAssemblyStandalone.conf"));
    }

    @Test
    public void testAssemblyShouldBeLocatableUsingLocationService() throws ExecutionException, InterruptedException {
        Connection.AkkaConnection connection = new Connection.AkkaConnection(new ComponentId("JPlcprototypeAssembly", JComponentType.Assembly));
