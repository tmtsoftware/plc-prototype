...
public class JPlcprototypeHcdTest extends JUnitSuite {
    ...
    public static void setup() {
        ...
        testKit.spawnStandalone(com.typesafe.config.ConfigFactory.load("JPlcprototypeHcdStandalone.conf"));
    }

    @Test
    public void testHcdShouldBeLocatableUsingLocationService() throws ExecutionException, InterruptedException {
        Connection.AkkaConnection connection = new Connection.AkkaConnection(new ComponentId("JPlcprototypeHcd", JComponentType.HCD));
